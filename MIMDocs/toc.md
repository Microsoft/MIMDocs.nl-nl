...
#### [Technische documentatie voor MIIS 2003](https://technet.microsoft.com/library/cc720628)
#### [Uitvoerprofielen in MIIS 2003](https://technet.microsoft.com/library/cc720554)
#### [Op status gebaseerde verwerking in MIIS 2003](https://technet.microsoft.com/library/cc720564)
#### [Synchronisatieregels in MIIS 2003](https://technet.microsoft.com/library/cc720559)
### MIM-service
#### [Inleiding tot uitgaande synchronisatie op basis van filter](https://technet.microsoft.com/library/jj133869)
#### [Inleiding tot inkomende synchronisatie](https://technet.microsoft.com/library/jj133856)
...
### [Implementatiehandleiding voor forest-overschrijdend beheer](https://technet.microsoft.com/library/ff721965)
### [Problemen oplossen in FIM 2010](https://technet.microsoft.com/library/gg607341)
### [Groepen inrichten voor AD DS](https://technet.microsoft.com/library/ff686261)
### [Gebruikers inrichten voor AD DS](https://technet.microsoft.com/library/ff686263)
### [Groepen uit AD DS synchroniseren met FIM](https://technet.microsoft.com/library/ff686936)
### [Gebruikers uit AD DS synchroniseren met FIM](https://technet.microsoft.com/library/ff686264)
...
### [Synchronisatie van globale adreslijst (GAL) met Microsoft Forefront Identity Manager (FIM) 2010 configureren](https://technet.microsoft.com/video/configuring-global-address-list-gal-synchronization-with-forefront-identity-manager-fim-2010.aspx)
### [Meer informatie over gegevenssynchronisatie met externe systemen](https://technet.microsoft.com/library/ff608273)
### [Meer informatie over ongedaan maken van de inrichting](https://technet.microsoft.com/library/hh859718)
...
## Selfservice voor opnieuw instellen van wachtwoord
...
### Connectors
### Selfservice voor opnieuw instellen van wachtwoord
## [Veelgestelde vragen](https://support.microsoft.com/lifecycle/search?alpha=Microsoft%20Forefront%20Identity%20Manager%202010,Microsoft%20Identity%20Manager%202016)
...
## Synchronisatieservice
### [Referentie voor ontwikkelaars voor synchronisatieservice](https://msdn.microsoft.com/library/jj131732)
### [Referentie voor beheeragent uitbreidbare connectiviteit 2.2](https://msdn.microsoft.com/library/hh859557)
### [Referentie voor Synchronization Service Manager](https://msdn.microsoft.com/library/jj154546)
### [ILM 2007 FP1-uitbreidingen testen en fouten erin opsporen](https://msdn.microsoft.com/library/ms698774)
...
### [Beheeragents in FIM 2010](https://technet.microsoft.com/library/ff608275)
### [XML-referentie van weergaveconfiguratie voor resourcebeheer](https://technet.microsoft.com/library/ee534918)
### [Registersleutels en instellingen van configuratiebestand in FIM 2010](https://technet.microsoft.com/library/ff800821)
### [Terminologie en woordenlijst](https://technet.microsoft.com/library/ee534910)
### [Windows PowerShell voor hulpprogramma's voor FIM 2010](https://technet.microsoft.com/library/ff394140)
### [Aangepaste acties voor FIM 2010](https://technet.microsoft.com/library/jj159300)
## [Referentie voor MSDN-ontwikkelaars](https://msdn.microsoft.com/library/windows/desktop/ee652263)
