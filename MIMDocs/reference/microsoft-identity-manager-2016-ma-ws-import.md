---
title: Web Services-connector importeren | Microsoft Docs
description: Importeer webservices-connector met configuraties met meerdere webservices in Microsoft Identity Manager.
keywords: ''
author: billmath
ms.author: billmath
manager: daveba
...
ms.locfileid: "92758770"
---
# <a name="import-web-services-connector"></a>Web Services-connector importeren

Wanneer de import server configuratie bewerking die de Web Services-beheer agent (MA) bevat, is voltooid met de fout ' kan configuratie parameters niet ophalen uit de uitbrei ding ', moeten de geëxporteerde configuratie bestanden worden gecontroleerd.

De fout wordt veroorzaakt door een beperking in de synchronisatie service. De service kan de server configuratie niet importeren met de webservices MA en retourneert de fout ' kan de configuratie parameters niet ophalen uit de extensie '. In sommige gevallen kan de Web Services-MA ongeldige instellingen bevatten die moeten worden opgelost. 

## <a name="how-to-fix-the-issue"></a>Het probleem oplossen

1. Kopieer de configuratie bestanden van de server naar de doel server. 

2. Kopieer op de doel server de <a href="#web-service-powershell-script">WebServiceMA_apply_before_import_server_configuration.ps1</a> Power shell-script naar de map met de geëxporteerde bestanden voor de server configuratie.

3. Voer het WebServiceMA_apply_before_import_server_configuration.ps1 Power shell-script uit.
